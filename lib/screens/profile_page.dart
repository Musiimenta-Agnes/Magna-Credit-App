...
// //     // This happens when the server returns success:true but user:null
...
// //               ),
// //               child: const Icon(Icons.person_outline_rounded, size: 64, color: kBlue),
// //             ),
...
// //             child: const Text('Cancel', style: TextStyle(color: kBlue)),
// //           ),
// //           ElevatedButton(
...
// //       // Clear notifications on logout so next user won't see them
// //       try { await ApiService.clearAllNotifications(); } catch (_) {}
...
// //               const Icon(Icons.manage_accounts_rounded, color: kBlue, size: 18),
// //               const SizedBox(width: 6),
// //               const Text('Account',
// //                   style: TextStyle(color: kBlue, fontSize: 15, fontWeight: FontWeight.w700)),
// //             ]),
// //             const SizedBox(height: 16),
...
// //                     child: const Icon(Icons.settings_rounded, color: kBlue, size: 20),
// //                   ),
// //                   const SizedBox(width: 14),
// //                   const Expanded(
// //                     child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
...
// //                       Text('App preferences & notifications',
...
// // // ════════════════════════════════════════════════════════════════
// // //  GUEST PROMPT — shown on all tabs when not logged in
// // // ════════════════════════════════════════════════════════════════
...
// //               shape: BoxShape.circle,
// //             ),
// //             child: const Icon(Icons.lock_outline_rounded, size: 56, color: kBlue),
// //           ),
// //           const SizedBox(height: 20),
// //           const Text(
// //             'Not logged in',
...
// //                                   color: _existingCount > 0 ? kBlue : Colors.redAccent, size: 30),
// //                             ),
// //                             const SizedBox(height: 10),
// //                             Text(
// //                               _existingCount > 0 ? 'Tap to replace collateral images' : 'Tap to upload collateral images',
// //                               style: TextStyle(color: _existingCount > 0 ? Colors.grey : Colors.redAccent, fontSize: 13),
// //                             ),
// //                             const SizedBox(height: 4),
// //                             Text(
// //                               _existingCount > 0
...
// //                     ),
// //                     child: Column(children: [
// //                       _balRow('Loan Amount',  'UGX ${fmtUGX(loanDetail!['loan_amount'])}', Colors.white),
// //                       const SizedBox(height: 8),
// //                       _balRow('Total Repaid', 'UGX ${fmtUGX(loanDetail!['total_repaid'])}', const Color(0xFF7FFFC4)),
// //                       const SizedBox(height: 8),
// //                       _balRow('Balance', 'UGX ${fmtUGX(loanDetail!['balance'])}',
...
// // // ════════════════════════════════════════════════════════════════
// // //  Notification Bell — shown in ProfilePage AppBar
// // // ════════════════════════════════════════════════════════════════
...
// //         );
// //         _loadUnread(); // refresh count after returning
// //       },
// //       child: Stack(children: [
// //         const Padding(
// //           padding: EdgeInsets.all(8),
// //           child: Icon(Icons.notifications_rounded, color: Colors.white, size: 26),
// //         ),
// //         if (_unread > 0)
// //           Positioned(
// //             right: 4, top: 4,
...
// //           Row(children: [
// //             _det('Repaid',  'UGX ${fmtUGX(loan['total_repaid'])}'),
// //             const SizedBox(width: 16),
// //             _det('Balance', 'UGX ${fmtUGX(loan['balance'])}'),
// //           ]),
...
//                 style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: kBlue)),
//             const SizedBox(height: 8),
//             Text('Please log in to view your dashboard, loans, and repayments.',
//                 textAlign: TextAlign.center,
//                 style: TextStyle(fontSize: 14, color: Colors.grey[600])),
//           ]),
//         ),
...
//               details: const [
//                 _PaymentDetail(label: 'MTN Mobile Money', value: '0771 000 000'),
//                 _PaymentDetail(label: 'Airtel Money',     value: '0701 000 000'),
//                 _PaymentDetail(label: 'Account Name',     value: 'Magna Credit Limited'),
//               ],
//             ),
...
//               details: const [
//                 _PaymentDetail(label: 'Bank Name',      value: 'Stanbic Bank Uganda'),
//                 _PaymentDetail(label: 'Account Number', value: '9030012345678'),
//                 _PaymentDetail(label: 'Account Name',   value: 'Magna Credit Limited'),
//                 _PaymentDetail(label: 'Branch',         value: 'Kampala Main Branch'),
//               ],
//             ),
...
//                 : Column(
//                     children: repayments
//                         .map((r) => _RepaymentCard(repayment: r, isDark: widget.isDark))
//                         .toList(),
//                   ),
...
//         border: Border.all(color: color.withOpacity(0.2)),
//         boxShadow: [
//           BoxShadow(color: color.withOpacity(0.07), blurRadius: 12, offset: const Offset(0, 4)),
//         ],
//       ),
//       child: Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
...
//           Container(
//             padding: const EdgeInsets.all(24),
//             decoration: BoxDecoration(color: kBlue.withOpacity(0.07), shape: BoxShape.circle),
//             child: const Icon(Icons.lock_outline_rounded, size: 56, color: kBlue),
//           ),
//           const SizedBox(height: 20),
//           const Text('Not logged in',
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Column(children: [
            // ── Avatar (initial letter only, no image) ──
            CircleAvatar(
              radius: 44,
              backgroundColor: Colors.white24,
              child: Text(
                nameCtrl.text.isNotEmpty ? nameCtrl.text[0].toUpperCase() : 'U',
                style: const TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.w700),
              ),
            ),
            const SizedBox(height: 12),
