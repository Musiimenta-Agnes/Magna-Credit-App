...
//   // 🔹 User Data Controllers (Future API-ready)
//   final TextEditingController nameController =
//       TextEditingController(text: "John Doe");
//   final TextEditingController emailController =
//       TextEditingController(text: "johndoe@example.com");
...
//               children: [
//                 _buildField("Occupation", occupationController),
//                 _buildField("Monthly Income", incomeController),
//               ],
//             ),
...
//                 ),
//                 onPressed: () {
//                   // Navigate only to LoanApplicationPage
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                       builder: (context) => const LoanApplicationPage(),
