...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  bool _submitted = false; // tracks if register button was pressed
        ...
        builder: (context) {
          ...
          return TextFormField(
            ...
            decoration: InputDecoration(
              prefixIcon: const Icon(Icons.phone_rounded, color: _green, size: 20),
              prefixText: '+256 ',
            ...
            validator: (value) {
              if (value == null || value.isEmpty) return 'Please fill in this field';
              if (value.length != 9) return 'Enter 9 digits after +256';
              return null;
            },
          );
        },
      ...
      child: Builder(
        builder: (context) {
          ...
          return TextFormField(
            ...
            decoration: InputDecoration(
              prefixIcon: const Icon(Icons.lock_rounded, color: _green, size: 20),
              hintText: hintText,
              hintStyle: TextStyle(
                color: isDark ? Colors.white38 : Colors.black38,
                fontSize: 14,
