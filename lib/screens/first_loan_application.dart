          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // INPUT FIELDS
                _buildTextField(nameController, "Full Name", isDark: isDark),
                ...
                _buildTextField(bioInfoController, "Bio Information",
                    maxLines: 3, icon: Icons.info_outline, isDark: isDark),
                const SizedBox(height: 15),

                _buildTextField(locationController, "Location",
                    icon: Icons.location_on, isDark: isDark),
                const SizedBox(height: 15),
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    prefixIcon:
                        Icon(Icons.person_pin, color: const Color(0xFF007BFF)),
...
//       // TOP BAR
//       appBar: AppBar(
//         backgroundColor: isDark ? Colors.black : const Color(0xFF007BFF),
//         elevation: 0,
//         leading: IconButton(
//           icon: Icon(
//             Icons.arrow_back,
...
//                     },
//                     style: ElevatedButton.styleFrom(
//                       backgroundColor: isDark ? Colors.white : const Color(0xFF007BFF),
//                       padding: const EdgeInsets.symmetric(vertical: 14),
//                       shape: RoundedRectangleBorder(
//                         borderRadius: BorderRadius.circular(8),
//                       ),
