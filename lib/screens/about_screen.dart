              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: _MiniCard(
                          ...
                          title: 'Our Vision',
                          text: 'To become the most trusted and innovative financial service provider in the region.',
                          color: _blue,
                          isDark: isDark,
                        ),
                      ),
                      ...
                      Expanded(
                        child: _MiniCard(
                          ...
                          title: 'Our Mission',
                          text: 'To empower individuals and businesses with transparent and efficient credit solutions.',
                          color: _green,
                          isDark: isDark,
                        ),
                      ),
                  ...
                  _SectionCard(
                    ...
                    isDark: isDark,
                    items: const [
                      _LoanItem(icon: Icons.build_rounded,           label: 'Asset Financing', desc: 'Finance for acquiring productive assets.'),
                      ...
                      _LoanItem(icon: Icons.badge_rounded,           label: 'Salary Loans',    desc: 'Loans advanced against your monthly salary.'),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: const [
                        Row(children: [
                          Icon(Icons.contact_phone_rounded, color: Colors.white, size: 20),
                          SizedBox(width: 8),
                          Text('Contact Us',
        ...
        children: [
          Row(children: [
            ...
            const Text('Our Core Values',
                style: TextStyle(color: _blue, fontWeight: FontWeight.bold, fontSize: 15)),
          ]),
          const SizedBox(height: 16),
          GridView.count(
            crossAxisCount: 2,
...
//       );
//     } else if (index == 2) {
//       // ── Check login before going to Profile ──
//       final prefs = await SharedPreferences.getInstance();
//       final token = prefs.getString('token') ?? '';
